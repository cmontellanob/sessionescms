...
// register meta box
function myplugin_add_meta_box_libros() {

	$post_types = array( 'libros' );

	foreach ( $post_types as $post_type ) {

		add_meta_box(
			'myplugin_meta_box_libros',         // Unique ID of meta box
			'MyPlugin Meta Box libros',         // Title of meta box
			'myplugin_display_meta_box_libros', // Callback function
			$post_type                   // Post type
		);
...
add_action( 'add_meta_boxes', 'myplugin_add_meta_box_libros' );



// display meta box
function myplugin_display_meta_box_libros( $post ) {
